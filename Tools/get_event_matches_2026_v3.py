...
# database(s).
#
# This is an updated version of get_event_matches_2026_v2.
# Changes include:
#
# 1: Added client.admin.command("ping") check in get_database() to verify
#    connectivity before returning the database handle.
# 2: Updated db-is-None error blocks to match the style used in
#    get_match_breakdown_2026_v3.py.
...
def main() -> None:
    ...
    with ApiClient(configuration) as api_client:
        ...
        event_code: str = (
            input("Enter the event code for the event to get data for "
                  "(or 'quit' to exit): ")
            .strip()
        )
