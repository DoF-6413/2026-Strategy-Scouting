...
#
# This is an updated version of get_event_schedule_from_mongodb_2026_v1.py.
# Changes include:
#
# 1: Added client.admin.command("ping") check in get_database() to verify
#    connectivity before returning the database handle.
# 2: Updated db-is-None error block to match the style used in
#    get_match_breakdown_2026_v3.py.
#
# NOTE: If the imports below fail, make sure you did a 'uv sync' before
# running the script.
